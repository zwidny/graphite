    ...
    if action == 'save':
        ...
        try:
            ...
            try:
                ...
                log.exception(
                    "Failed to create new MyGraph in /composer/mygraph/, graphName=%s" % graphName)
...
def send_email(request):
    try:
        ...
        assert resp.status == 200, "Failed HTTP response %s %s" % (
        ...
        text = MIMEText(
            "Image generated by the following graphite URL at %s\r\n\r\n%s" % (ctime(), url))
        ...
        s.sendmail('composer@%s' % gethostname(),
